...
Site visits were made opportunistically depending on precipitation throughout Summer/Fall 2021, and once in Spring 2022. At each site visit, the pressure transducer is downloaded and a discharge measurement is collected using a SondeTek Flowtracker. See Figure \@ref(fig:rating-curve1) for the discharge rates and staff plate values observed to date.
...
knitr::include_graphics("output/discharge_results/discharge_rating_curve_20220912.jpg")
```
...
<!--chapter:end:04-fish_rescue.Rmd-->
