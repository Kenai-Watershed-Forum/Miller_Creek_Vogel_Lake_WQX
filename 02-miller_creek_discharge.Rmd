...
As of `r Sys.Date()`, an insufficient number of discharge observations exist to make a reliable discharge rating curve for Miller Creek. As a result, the pressure transducer data in \@ref(fig:pt-data) is shown in raw form rather than as converted to stream discharge values.
