...
[![Click the image above to access the full ArcGIS Online map. The map layer titled "Rotenone Sampling" contains interactive click-able points with sampling details including coordinates.](images/miller_map.png "Miller Creek and Vogel Lake Watershed"){width="500"}](https://arcg.is/199PPj)
